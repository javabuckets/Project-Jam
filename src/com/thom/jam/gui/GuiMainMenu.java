...
public class GuiMainMenu extends GuiScreen
{
	...
	public void drawScreen(int width, int height) 
	{
		...
		/*Button btnTest = new Button(ImageHandler.getIcon(assetsPath + "idle.png")).addIdleState(ImageHandler.getIcon(assetsPath + "idle.png")).addHoverState(ImageHandler.getIcon(assetsPath + "hover.png"));
		btnTest = ComponentHandler.addButton(btnTest, new Point(70, 200), new Dimension(200, 50), "Test");
		...
		{
			SoundHandler.playSoundAsLoop(assetsPath + "sounds\\" + "menu_loop16.wav");
		}
